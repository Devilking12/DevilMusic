...
class App(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("About_Devil_XD")
                await self.one.join_chat("DevilXD_World")
                await self.one.join_chat("Devil_fedban")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("About_Devil_XD")
                await self.one.join_chat("DevilXD_World")
                await self.one.join_chat("Devil_fedban")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("About_Devil_XD")
                await self.one.join_chat("DevilXD_World")
                await self.one.join_chat("Devil_fedban")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("About_Devil_XD")
                await self.one.join_chat("DevilXD_World")
                await self.one.join_chat("Devil_fedban")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("About_Devil_XD")
                await self.one.join_chat("DevilXD_World")
                await self.one.join_chat("Devil_fedban")
            except:
                pass
